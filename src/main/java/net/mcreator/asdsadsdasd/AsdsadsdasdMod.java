 ...
 *
 */
package net.mcreator.asdsadsdasd;
...
@Mod("asdsadsdasd")
public class AsdsadsdasdMod {
	public static final Logger LOGGER = LogManager.getLogger(AsdsadsdasdMod.class);
	public static final String MODID = "asdsadsdasd";
